  ...
  ({ lesson, onChangeConfirm }, ref) => {
    ...
    return (
      <InfoBlockStyled ref={ref}>
        <section
          className="ksu-content no-margin print-block"
          ref={componentRef}>
...
: (
                        <ButtonIconStyled
                          onClick={() => editLessonHandler('goal')}>
                          <SaveIcon />
                        </ButtonIconStyled>
                      )}
                    </div>
...
: (
                        <ButtonIconStyled
                          onClick={() => editLessonHandler('bible')}>
                          <SaveIcon />
                        </ButtonIconStyled>
                      )}
                    </div>
                        ...
                        render={({ field }) => (
                          <FormField>
                            <InputStyled
                              ...
                              onChange={({ target }) =>
                                setValue('bibleText', target.value)
                              }
                              {...field}
                            />
                          </FormField>
                        ...
                        render={({ field }) => (
                          <FormField>
                            <InputStyled
                              ...
                              onChange={({ target }) =>
                                setValue('bibleQuote', target.value)
                              }
                              {...field}
                            />
                          </FormField>
...
: (
                    <ButtonIconStyled
                      onClick={() => editLessonHandler('material')}>
                      <SaveIcon />
                    </ButtonIconStyled>
                  ))
                }>
